...
#Build protctor sidecar image
docker build  --tag protector . 
docker tag protector us.icr.io/dev_sec_ops/protector:latest
docker push us.icr.io/dev_sec_ops/protector:latest
#kubectl apply -f deploy/sidecarexample.yaml 
#kubectl rollout restart deployment protected-app 
