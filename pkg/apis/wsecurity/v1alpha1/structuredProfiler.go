...
func (profile *StructuredProfile) Profile(args ...interface{}) {
	data := args[0]
	if data == nil {
		return
	}
...
func (pile *StructuredPile) Add(valProfile ValueProfile) {
	profile := valProfile.(*StructuredProfile)
...
func (pile *StructuredPile) Merge(otherValPile ValuePile) {
	otherPile := otherValPile.(*StructuredPile)
	if pile.Kind == KindEmpty {
...
func (config *StructuredConfig) Decide(valProfile ValueProfile) string {
	profile := valProfile.(*StructuredProfile)
...
func (config *StructuredConfig) Learn(valPile ValuePile) {
	pile := valPile.(*StructuredPile)
...
func (config *StructuredConfig) Fuse(otherValConfig ValueConfig) {
	otherConfig := otherValConfig.(*StructuredConfig)
