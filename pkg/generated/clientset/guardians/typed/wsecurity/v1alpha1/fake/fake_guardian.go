...
import (
	...
	v1alpha1 "github.com/IBM/workload-security-guard/pkg/apis/wsecurity/v1alpha1"
...
var guardiansResource = schema.GroupVersionResource{Group: "wsecurity", Version: "v1alpha1", Resource: "guardians"}

var guardiansKind = schema.GroupVersionKind{Group: "wsecurity", Version: "v1alpha1", Kind: "Guardian"}
...
func (c *FakeGuardians) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(guardiansResource, c.ns, name), &v1alpha1.Guardian{})
