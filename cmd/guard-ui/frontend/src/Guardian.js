...
function Guardian(props) {
  ...
  return (
    ...
    > 
        ...
        <Criteria data={data.configured}  nodeId="Configured" name="Configured" onDataChange={handleConfiguredChange}></Criteria>    
        <Criteria data={data.learned}  nodeId="Learned" name="Learned" onDataChange={handleLearnedChange}></Criteria>  
    </TreeView>
  );
}
