...
function Criteria(props) {
  ...
  //console.log("data.active in Criteria", data.active)  
  ...
  //console.log("val in Criteria", val)  
  console.log("val.active in Criteria", active)  
  ...
  useEffect(() => {
    ...
    console.log("val.active in Criteria", data.active)  
  ...
  console.log("Criteria data",name,  data)
