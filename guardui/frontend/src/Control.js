...
import {Stack, MenuItem, FormGroup, Checkbox} from '@mui/material';
...
const learnMenuTips = {
                  "disable": "Never learn", 
                  "enable": "Learn from all acceptable occurrences (where there is no alert)", 
                }
...
function Control(props) {
  ...
  learnMenuVal = learnVal? "enable" : "disable"
